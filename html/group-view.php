                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-sm-2">
                      ...
                      <input class="form-control form-control-sm" type="text" readonly value="그룹1">
                    </div>
                    <div class="form-group col-sm-4">
                      <label for="group_name">그룹명</label>
                      <input class="form-control form-control-sm" id="group_name" type="text" placeholder="" value="시스템 일반 관리자">
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-sm-12">
                      <label for="memo">메모</label>
                      <input class="form-control form-control-sm" id="memo" type="text" placeholder="" value="시스템 일반 관리자">
                    </div>
                  </div>
